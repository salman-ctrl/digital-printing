    ...
    <form action="{{ route('admin.categories.store') }}"
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 h-full">
                ...
                <button type="button"
                        id="removeImage"
                        class="hidden mt-4 w-full py-3 rounded-xl bg-red-50 text-[#EF4444]
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            {{-- ================= EMPTY STATE ================= --}}
            {{-- Disiapkan untuk kondisi tanpa data (opsional) --}}

            {{-- ================= FEEDBACK ================= --}}
            {{-- Success / Error message bisa ditambahkan di sini --}}
