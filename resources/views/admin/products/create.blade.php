...
<div class="max-w-5xl mx-auto space-y-8 font-[Inter] text-slate-800">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">
                Input data produk baru ke sistem
            </p>
        </div>
    ...
    <form action="{{ route('admin.products.store') }}"
        ...
        {{-- Hidden input final category --}}
        <input type="hidden" name="category_id" id="finalCategory" value="{{ old('category_id') }}">
        ...
        <div class="lg:col-span-2 bg-white rounded-3xl border border-slate-200 shadow-sm p-8 space-y-6">
            ...
            <div>
                ...
                <input type="text"
                       ...
                       placeholder="Contoh: Brosur Art Paper">
            </div>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex items-center gap-3">
                        <input type="checkbox" name="installation_available" value="1" {{ old('installation_available') ? 'checked' : '' }}
            ...
            <div>
                ...
                <input type="number"
                       ...
                       value="{{ old('installation_price', 0) }}"
                       class="w-full mt-2 px-4 py-3 rounded-2xl border border-slate-200
                              focus:ring-2 focus:ring-[#FACC15]/30 focus:border-[#FACC15]
                              text-sm font-semibold text-slate-800 outline-none transition">
            </div>
            ...
            <div>
                ...
                <textarea name="description"
                          ...
                          class="w-full mt-2 px-4 py-3 rounded-2xl border border-slate-200
                                 focus:ring-2 focus:ring-[#FACC15]/30 focus:border-[#FACC15]
                                 text-sm font-semibold text-slate-800 outline-none transition">{{ old('description') }}</textarea>
            </div>
